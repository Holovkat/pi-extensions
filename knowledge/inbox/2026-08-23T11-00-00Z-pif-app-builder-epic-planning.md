...
- The agentic build flow (brief → foundations → widget-extensions → pages) rides the existing real-use trial-proven loop (create → write Dart → analyze gate → live reload) through child sessions.
