...
- **v1 base widgets:** Agent Console, Session Rail, Terminal (pty), Widget Store panel, Status Bar. Diff Viewer and File Explorer deliberately deferred to become the first dogfooded widgets Pi builds through pif itself; the diff-viewer dogfood is the Phase 1 exit criterion.
